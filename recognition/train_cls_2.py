...
from loader2 import get_train_val_loaders
from balanced_loader import get_balanced_train_val_loaders
import cv2
from models import FeatureNetV2
...
def create_model(args):
    model = FeatureNetV2(args.backbone, num_classes=args.num_classes, cls_model=None, suffix_name=args.suffix_name)
...
def train(args):
    ...
    _, val_loader = get_train_val_loaders(args.num_classes, args.start_index, batch_size=args.batch_size, val_batch_size=args.val_batch_size, val_num=args.val_num)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        train_loader, val_loader = get_train_val_loaders(args.num_classes, args.start_index, batch_size=args.batch_size, dev_mode=args.dev_mode, val_batch_size=args.val_batch_size, val_num=args.val_num)
        train_loss = 0
        total_trip_loss = 0.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--suffix_name', type=str, default='RecoNet224')
